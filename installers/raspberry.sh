...
if git clone --depth=1 https://github.com/simensma/MagicMirror.git; then
...
echo -e "\e[90mInstalling and Configuring pm2 for autostarting MagicMirror"
...
echo -e "\e[90mDisabling screen saver"
